...
class staticObject extends StatefulWidget {
  static const routename = '/static_object';
  @override
  State<staticObject> createState() => _staticObjectState();
}

class _staticObjectState extends State<staticObject> {
